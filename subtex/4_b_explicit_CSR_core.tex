...
\subsubsection{Control structure}\label{EMPC:sec:ControlStruct}
    ...
    \item \hlc[PT]{Reach the steady state reference of $i_dc$ the fastest possible with minimal overshoot on the resistive load's poles.}
    \end{itemize}
