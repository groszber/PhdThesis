...
\subsubsection{Control structure}\label{EMPC:sec:ControlStruct}
    ...
    \item \hlc[PT]{\textbf{Modulation:} The modulation shall transform the reference current into the optimal switching state, which was permitted by the modulation table. Also, the desired optimal switching sequence shall be reached with minimum amount of switching used.}
    \end{itemize}
