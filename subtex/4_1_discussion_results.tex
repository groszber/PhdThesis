...
\textbf{Write here free text why this is noteworthy.}\\
...
\section{Discussion}\section{Modulation}\label{EMPC:sec:Discussion}
    ...
    \subsection{Computational effort}\section{Modulation}\label{EMPC:sec:CompEffort}
    ...
    \subsection{Horizon performance}\section{Modulation}\label{EMPC:sec:Performance}
    ...
    \subsection{Simulation results}\section{Modulation}\label{EMPC:sec:Results}
    ...
    \subsection{Comparison with a state feedback control}\section{Modulation}\label{EMPC:sec:Comparison}
...
\section{Conclusion}\section{Modulation}\label{EMPC:sec:Conclusion}
