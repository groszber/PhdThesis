\chapter[Predictive control of a CSR]{Constrained, explicit predictive control for current source buck-type rectifiers}
...
\section{Discussion}
    ...
    \subsection{Horizon performance}
    ...
    \subsection{Comparison with a state feedback control}
