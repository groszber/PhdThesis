\chapter[Voltage unbalance compensation]{Voltage unbalance compensation with optimization based control algorithm and asymmetrical inverter structure}
...
\section{The method's additional content compared to VUF}
            ...
            When using a new method for calculation and cost function it is reasonable to test it's usability against the prevalent or regulated method. In this case the geometrical norm's utility (\ref{equ:geom}) against the VUF (\ref{equ:regular}) value. 
