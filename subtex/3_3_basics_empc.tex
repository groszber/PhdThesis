\section{Power electronic components for current control}
...
\begin{equation}
    ...
    where $U_0=[\textbf{u}'_0,\dots,\textbf{u}'_{N-1}]in\mathbb{R}^s$, $s=m*N$ is the desision vector contraining all future inputs, also $\textbf{P}=\textbf{P}'\succeq 0$, $\textbf{Q}=\textbf{Q}'\succeq 0$, $\textbf{R}=\textbf{R}'\succeq 0$.
