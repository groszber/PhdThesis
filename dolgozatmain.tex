...
\definecolor{PT}{RGB}{253,214,236}
\definecolor{MA}{RGB}{204,230,255}
\definecolor{KP}{RGB}{253,238,204}
%\definecolor{PT}{RGB}{255,255,255}
%\definecolor{MA}{RGB}{255,255,255}
%\definecolor{KP}{RGB}{255,255,255}
...
%     \begin{center}
%        \vspace{4cm}
%        \textbf{ \textsc{\textcolor{yellow!50!orange}{\LARGE DOCTORAL (PhD) THESIS }}}\\[4cm]
...
% Title Page
 %\input{subtex/0_borito.tex}
 % Title Page
 \input{subtex/00_cimoldal.tex}

% Mandatory third page
 \input{subtex/000_thirdpage.tex}

% Acknowledgements
 \input{subtex/0000_acknowledgments.tex}
