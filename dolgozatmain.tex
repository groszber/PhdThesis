...
\input{subtex/3_unbalance_compensation.tex}
\input{subtex/3_a_notations_unbalance_compensation.tex}

%% Explicit CSR
\input{subtex/4_a_explicit_CSR_basics.tex}
\input{subtex/4_b_explicit_CSR_core.tex}
\input{subtex/4_c_explicit_CSR_notations.tex}

%\input{subtex/3_1_basics_unbalance.tex}
%\input{subtex/3_2_basics_powelectric.tex}
...
%% Appendix
\input{subtex/7_appendix.tex}
\input{subtex/8_appendix_notations.tex}

%% Abbreviations
\input{subtex/9_abbreviations.tex}
